...
void HAL_TIM_Base_MspInit(TIM_HandleTypeDef* tim_baseHandle)
{
  ...
  /* USER CODE END TIM2_MspInit 0 */
    ...
    PA3     ------> TIM2_CH4
    */
    GPIO_InitStruct.Pin = US1_ECHO_Pin|US2_ECHO_Pin|US3_ECHO_Pin;
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* timHandle)
{
  ...
  /* USER CODE END TIM3_MspPostInit 0 */
    ...
    PB5     ------> TIM3_CH2
    */
    GPIO_InitStruct.Pin = PWM_Sterring_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF2_TIM3;
    HAL_GPIO_Init(PWM_Sterring_GPIO_Port, &GPIO_InitStruct);
  ...
  /* USER CODE END TIM12_MspPostInit 0 */
    ...
    PB15     ------> TIM12_CH2
    */
    GPIO_InitStruct.Pin = PWM_M4_Pin|PWM_M3_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
...
void HAL_TIM_Base_MspDeInit(TIM_HandleTypeDef* tim_baseHandle)
{
  ...
  /* USER CODE END TIM2_MspDeInit 0 */
    ...
    PA3     ------> TIM2_CH4
    */
    HAL_GPIO_DeInit(GPIOA, US1_ECHO_Pin|US2_ECHO_Pin|US3_ECHO_Pin);
